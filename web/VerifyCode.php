...
{  
   ...
   setcookie($this->session_flag, strtolower($this->checkcode)."#".$ctime."#".md5(strtolower($this->checkcode).$ctime."mpxiaoyao"), 0,"/");
...
{  
   ...
   $border = imagecolorallocate($this->checkimage,215,215,215);    
