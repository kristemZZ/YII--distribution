...
class Excel
{
    public static function writerExcel($tableHead = array(), $rowArray = array(), $filename='excel.xls',$filesave=0)
    {
        file_put_contents('order.txt', print_r($tableHead, true).PHP_EOL, FILE_APPEND);
        $objPHPExcel = new PHPExcel ();
        $objPHPExcel->getProperties()->setCreator("小吆分销系统")->setLastModifiedBy("小吆分销系统")->setTitle("我的excel文档")->setSubject("文档导出测试")->setDescription("文档导出测试.")->setKeywords("office 2007 PHP数据")->setCategory("文档导出测试");
